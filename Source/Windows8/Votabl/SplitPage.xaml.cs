...
namespace EventBuddy
{
    ...
    /// </summary>
    public sealed partial class SplitPage : EventBuddy.Common.LayoutAwarePage
    {
        public SplitPage()
        {
        ...
        protected override async void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            var group = await SampleDataSource.GetCategory((int)navigationParameter);
            this.DefaultViewModel["Group"] = group;
            this.DefaultViewModel["Items"] = group.Items;

            itemsViewSource.View.CurrentChanged += async (source, args) =>
            {
                var currentEvent = (Event)itemsViewSource.View.CurrentItem;
                if (currentEvent == null)
                {
                    return;
                }
                var votables = await App.MobileService.GetTable<Votable>()
                    .Where(v => v.EventId == currentEvent.Id).ToEnumerableAsync();
                currentEvent.Votables.SetItems(votables);
                currentEvent.CalculateMaximum();
            };
        ...
        protected override void SaveState(Dictionary<String, Object> pageState)
        {
            ...
            {
                var selectedItem = (Event)this.itemsViewSource.View.CurrentItem;
        ...
        private async void btnVote_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            Vote vote = new Vote { VotableId = votable.Id, EventId = votable.EventId };
