...
namespace EventBuddy
{
    ...
    /// </summary>
    public sealed partial class NewEvent : LayoutAwarePage
    {
        public NewEvent()
        {
        ...
        private void btnAddVotable_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            txtVotable.Focus(FocusState.Keyboard);
        }

        private async void btnSaveNewEvent_Click_1(object sender, RoutedEventArgs e)
        {
